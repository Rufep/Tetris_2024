...
public class ZPiece extends Piece {
    ...
    public ZPiece(Game game) {
        ...
        squares[1] = new Square(Game.MAX_X / 2, 0, Color.orange, game); //
        squares[2] = new Square(Game.MAX_X / 2, Game.SQUARE_SIDE, Color.orange, game); // Cambiar coordenadas
        squares[3] = new Square(Game.MAX_X / 2 + Game.SQUARE_SIDE, Game.SQUARE_SIDE, Color.orange, game); // Cambiar coordena
